...
-- 1st task:- inserting new record in book
...
select  b.isbn, b.book_title,count(isd.issued_id) as issue_count
...
GROUP BY b.isbn, b.book_title;
 ...
 -- task 7:- retrieving on specific category
 select *from employee where salary>50000 and position='clerk';
 
-- task 8 :-total rental price(aggregration)
